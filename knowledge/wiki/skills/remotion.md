...
> **Nguồn:** [remotion-dev/skills](remotion-dev/skills/remotion)
> **Commit:** `8587710`
> **Generated:** 2026-05-03

> **Review:** 🚫 flagged
> **Flags:** embedded secret pattern in example (.env token assignment), suspicious hidden character in Mapbox style URL, external links to third-party resources should be reviewed
...
*Converted from autoskills — source: remotion-dev/skills/remotion @ 8587710*
...
> **Nguồn:** [sleekdotdesign/agent-skills](sleekdotdesign/agent-skills/design-mobile-apps)
> **Commit:** `a6799c7`
> **Generated:** 2026-05-03

> **Review:** 🚫 flagged
> **Flags:** External host referenced beyond allowed-hosts (api.iconify.design), Broad file-writing instruction to save screenshots/component HTML to project directory via shell commands
...
*Converted from autoskills — source: sleekdotdesign/agent-skills/design-mobile-apps @ a6799c7*
...
> **Nguồn:** [stripe/ai](stripe/ai/upgrade-stripe)
> **Commit:** `f6e8ff3`
> **Generated:** 2026-05-03

> **Review:** 🚫 flagged
> **Flags:** Embedded example secret pattern (`sk_test_xxx`) appears multiple times, External documentation links should be verified for legitimacy and necessity
...
*Converted from autoskills — source: stripe/ai/upgrade-stripe @ f6e8ff3*
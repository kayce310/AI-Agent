...
> **Nguồn:** [angular/skills](angular/skills/angular-developer)
> **Commit:** `fbda5f9`
> **Generated:** 2026-05-03

> **Review:** 🚫 flagged
> **Flags:** Broad/unconditional command execution guidance (`ng build`, `ng version`, `npm install`), Potentially unsafe package installation guidance in skill instructions, Minor internal inconsistency/off-topic examples in references
...
*Converted from autoskills — source: angular/skills/angular-developer @ fbda5f9*
...
> **Nguồn:** [clerk/skills](clerk/skills/clerk-chrome-extension-patterns)
> **Commit:** `9d32bf4`
> **Generated:** 2026-05-03

> **Review:** 🚫 flagged
> **Flags:** Contains example curl command with placeholder secret authorization header, Suggests broad host permission pattern `<all_urls>` in content script manifest example, Includes instruction to disable bot protection/security feature in dashboard
...
*Converted from autoskills — source: clerk/skills/clerk-chrome-extension-patterns @ 9d32bf4*
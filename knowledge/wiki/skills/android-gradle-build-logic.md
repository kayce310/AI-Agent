...
> **Nguồn:** [krutikJain/android-agent-skills](krutikJain/android-agent-skills/android-gradle-build-logic)
> **Commit:** `c5bf673`
...
*Converted from autoskills — source: krutikJain/android-agent-skills/android-gradle-build-logic @ c5bf673*
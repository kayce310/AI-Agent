...
/**
 * Coral ResponseCache — LRU + TTL Cache for LLM Responses
 * Phase 8.3a — Performance Optimization
 *
 * Phase 2 Updates:
 * - Side-effect detection: bypass cache for mutating operations
 * - Persona-aware key: includes CORAL.md hash in key
 */
...
export interface CacheKey {
  ...
  promptHash: string;
  /** Hash of persona file (CORAL.md) for cache invalidation on persona change */
  personaHash?: string;
}

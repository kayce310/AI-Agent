  ...
  switch (assertion.type) {
    ...
    case 'regex': {
      try {
        ...
        return { passed: regex.test(actual), error: undefined };
      } catch (err) {
    ...
    case 'similarity': {
      ...
      return { passed: sim >= threshold, error: undefined };
    }
    ...
    case 'custom': {
      try {
        ...
        return { passed: Boolean(result), error: undefined };
      } catch (err) {
